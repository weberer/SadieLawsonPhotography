...
const domain = "sadielawsonphotography.com"

var defaultConfig = {
    fromEmail: `postmaster@${domain}`,
    subjectPrefix: "SadieLawsonPhotography Email Forward: ",
    emailBucket: "slp-email",
    emailKeyPrefix: "",
    allowPlusSign: true,
    forwardMapping: {
        "sadie@sadielawsonphotography.com": [
            "weberer@outlook.com",
            "heilprinsadie@gmail.com"
        ],
        "@sadielawsonphotography.com": [
            "weberer@outlook.com"
        ],
    }
};
